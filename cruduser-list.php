...
$sql = "SELECT product.id as product_id , product.name as product_name,buy_time,order_detail.name as name,product.status,product.price,total,product.number FROM order_detail  JOIN product ON order_detail.id = product.id order by 4,1 asc";
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a class="btn btn-info" href="changecruduser.php?id=<?= $row["product_id"] ?>">修改</a></td>
                            <td><a class="btn btn-info" href="php/deletecruduser.php?id=<?= $row["product_id"] ?>">刪除</a></td>
                        </tr>
                    <?php
                        }
                    else : ?>
