                ...
                <tbody>
                    ...
                    <?php foreach($rows as $value){ ?>
                        <tr>
                            ...
                            <td>
                                <span  class="d-inline-block text-truncate align-middle" style="max-width:80px;">
                                    <?= $value["email"] ?>
                                </span>
                            </td>
                            <td>
                            ...
                            <td class="text-nowrap">
                                <span class="d-inline-block  align-middle" style="max-width:120px;">
                                    <a class="btn btn-info ml-2" href="guide.php?id=<?= $value["id"]?>"><i class="fas fa-pen"></i>瀏覽</a>
                                    <a class="btn btn-danger " href="deleteGuide.php?id=<?=$value["id"]?>"
                                        onclick="return confirmAct();"><i class="fa fa-trash"></i>刪除
                                    </a>
                                </span>
                            </td>
                        </tr>
