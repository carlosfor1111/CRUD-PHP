...
<body>
  ...
  <form class="box" method="post" action="userCreate.php" id="form">
    ...
    <div class="">
              <input type="text" class="form-control" id="account" placeholder="請輸入 4~8 碼帳號" name="account" >
    ...
    <input type="password" class="form-control" id="repassword" name="repassword" placeholder="請再次輸入你的密碼" >
