                                            ...
                                            <?php foreach ($rows as $value) { ?>
                                                <tr>
                                                    ...
                                                    <td class="function text-nowrap">
                                                        ...
                                                        <a href="member_read.php?id=<?= $value["id"] ?>" class="text-white btn btn-primary btn-md mb-2 text-nowrap"><i class="fa fa-eye"></i>瀏覽</a>

                                                        <a class="btn btn-info btn-md mb-2 text-nowrap" href="member_update.php?id=<?= $value["id"] ?>" id=""><i class="fas fa-pen"></i></i>修改</a>
