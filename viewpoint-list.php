...
$per_Page=10; //每頁商品數10
$start_item=($p-1)*10; //起始的商品=頁數-１在乘上６
    ...
    <div class="flex-fill bd-highlight p-0">
        <div class=" bg-light p-4" style="min-height:100vh ">
            ...
            <div class="row col-6 mt-4 d-flex justify-content-between">
                <form action="areaSearch.php" method="get" class="">
                <div class="d-flex">
                    <select class="form-select " name="select" id="select" style="color:#666; width:120px">
                    ...
                    <span style="color:#bbb; font-style:italic"><small>依地區搜尋</small></span>   
                </form>
                   
                   
            <!-- 主題搜尋 -->
                <form action="topicSearch.php" method="get" class="">
                    <div class="d-flex">
                        <select class="form-select" name="select" id="select" style="color:#666;width:120px">
                    ...
                    <span style="color:#bbb; font-style:italic"><small>依主題搜尋</small></span>            
                </form>
            </div>
