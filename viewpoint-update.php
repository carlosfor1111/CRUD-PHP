    ...
    <div class="flex-fill bd-highlight p-0">
        ...
        ?>  
                ...
                <div class="col-10 my-2">
                    <lable class="font-weight-bold form-label" for="">景點名稱：</lable>
                    <input class="mt-2 form-control" type="text" value="<?=$value["name"]?>" name="name"></input>
                </div>
                ...
                <div class="mt-4 col-5">
                    <label class="form-label font-weight-bold" for="">景點主題：</label>
                        <div>
                            ...
                            <option  class="form-control " value="<?=$topic["id"]?>" name=""><?=$topic["name"]?></option>
                            <?php } ?> 
                            </select>
                        </div>
                </div>
